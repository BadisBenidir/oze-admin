                  ...
                  <tbody>
                    {stats.statusBreakdown.map((status) => {
                      ...
                      const statusColors: { [key: string]: string } = {
                        ...
                        'draft-b2b': 'bg-gray-100 text-gray-800',
                        'sourced-b2b': 'bg-violet-100 text-violet-800',
                        'drop-b2b': 'bg-violet-100 text-violet-800',
                    ...
                    <tr key={product.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-3 md:py-4 px-4 md:px-6">
                        <Badge variant={
                          ...
                          product.status === 'draft' || product.status === 'draft-b2b' || product.status === 'cadeau' ? 'default' :
                          'info'
                        }>
                          {product.status === 'draft' ? 'Brouillon' :
                           product.status === 'draft-b2b' ? 'Brouillon (B2B)' :
                           product.status === 'sourced-b2b' ? '🎯 Sourcing sur mesure' :
                           product.status === 'drop-b2b' ? '🚀 Programmé (Drop)' :
