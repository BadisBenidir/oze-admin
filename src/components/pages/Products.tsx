                  ...
                  <tbody>
                    {stats.statusBreakdown.map((status) => {
                      ...
                      const statusColors: { [key: string]: string } = {
                        ...
                        'sourced-b2b': 'bg-violet-100 text-violet-800',
                        ...
                        'cadeau': 'bg-amber-100 text-amber-800',
                        'cadeau-attribue': 'bg-blue-100 text-blue-800',
                        'cadeau-livre': 'bg-green-100 text-green-800'
                      };
                    ...
                    <tr key={product.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-3 md:py-4 px-4 md:px-6">
                        <Badge variant={
                          ...
                          product.status === 'sold-display' || product.status === 'for-auction-live' || product.status === 'reserved-b2b' || product.status === 'cadeau-attribue' ? 'info' :
                          product.status === 'sourced-b2b' ? 'purple' :
                          product.status === 'draft' || product.status === 'cadeau' ? 'default' :
                          'info'
                        }>
                          {product.status === 'draft' ? 'Brouillon' :
                           ...
                           product.status === 'sold-other-platform' ? 'Vendu ailleurs' :
                           product.status === 'cadeau' ? '🎁 Cadeau (en attente)' :
                           product.status === 'cadeau-attribue' ? '🎁 Cadeau attribué' :
                           product.status === 'cadeau-livre' ? '🎁 Cadeau livré' :
                           'Vendu ailleurs'}
                        </Badge>
                      </td>
                      <td className="py-3 md:py-4 px-4 md:px-6">
