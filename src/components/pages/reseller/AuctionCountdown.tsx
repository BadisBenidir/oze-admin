...
export const AuctionCountdown: React.FC<{ endsAt: string; className?: string }> = ({ endsAt, className = 'text-sm' }) => {
  ...
  return (
    <span className={`font-mono font-semibold tabular-nums ${ended ? 'text-gray-400' : urgent ? 'text-red-600' : 'text-gray-900'} ${className}`}>
