-- ============================================================================
-- Retire l'auto-assignation à delivery_batches de confirm_b2b_payment et
-- pay_b2b_order_with_wallet : le système delivery_batches (0054-0058) est
-- remplacé par un suivi de statut par article (voir 0062/0063 — cycle
-- ordered/received/ready_to_ship/delivery_requested/shipped +
-- shipments/shipment_parcels). La colonne orders.batch_id reste en base
-- (historique), simplement plus jamais renseignée pour les nouvelles
-- commandes. La table delivery_batches et ses RPCs restent en place.
--
-- Modification chirurgicale : le corps de chaque fonction est repris à
-- l'identique (confirmé via pg_get_functiondef avant écriture, migration
-- 0059), seules les lignes liées à v_batch_id/batch_id sont retirées.
-- ============================================================================
